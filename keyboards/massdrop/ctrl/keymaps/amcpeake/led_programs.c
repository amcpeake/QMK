...
// QWERTY
led_setup_t leds_qwerty[] = {
	{ .hs = 0, .he = 100, .rs = 137, .re = 73, .gs = 182, .ge = 143, .bs = 255, .be = 255, .ef = EF_NONE },
	{ .end = 1 },
};

// COLEMAK
led_setup_t leds_colemak[] = {
	{ .hs = 0, .he = 100, .rs = 255, .re = 186, .gs = 50, .ge = 9, .bs = 43, .be = 3, .ef = EF_NONE },
	{ .end = 1 },
};

// MOUSE
led_setup_t leds_mouse[] = {
	{ .hs = 0, .he = 100, .rs = 48, .re = 0, .gs = 255, .ge = 150, .bs = 62, .be = 10, .ef = EF_NONE },
        { .end = 1 },
};

// EMOJI
led_setup_t leds_emoji[] = {
	{ .hs = 0, .he = 100, .rs = 255, .re = 211, .gs = 242, .ge = 197, .bs = 71, .be = 0, .ef = EF_NONE },
        { .end = 1 },
};
